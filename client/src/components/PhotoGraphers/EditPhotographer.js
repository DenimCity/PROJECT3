...
updateCurrentState = () =>{
  ...
  axios.get(`api/photographers/${this.props.match.params.userId}`, this.state.photographer)
  .then(response => {
...
deletePhotographer = async (userId) => {
  try {
      ...
      const indexToDelete = this.state.photographers.indexOf(photographer)
